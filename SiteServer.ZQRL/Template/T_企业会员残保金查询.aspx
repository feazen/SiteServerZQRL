<%@ Page Language="C#" AutoEventWireup="true" Inherits="SiteServer.ZQRL.ForegroundPages.CompanyDisbilitymoneyInfos" %>
...
<div id="content">
    <div class="CompanyFundrate">
        <select  id="selectCompanyFund" style=" width:160px;" onchange="self.location.href=options[selectedIndex].value">
              ...
              <option selected="selected"  value="CompanyDisbilitymoneyInfo.aspx"> 残保金</option>
        </select>
    </div>
...
<div class="scroll">
  <table width="2000" border="0" cellspacing="0" cellpadding="0" id="tableList" style=" background-image:url(../images/s18.jpg)">
    <tbody><tr>
        ...
        <th  height="63"  align="center" class="u1">残保金比例</th>
        <th  height="63"  align="center" class="u1">残保金基数</th>
        <th  height="63"  align="center" class="u1">计算公式</th>
        <th  height="63"  align="center" class="u1">归口部门</th>
        <th  height="63"  align="center" class="u1">申报日期</th>
        <th  height="63"  align="center" class="u1">收取日期</th>
        <th  height="63"  align="center" class="u1">文件链接</th>
        <th  height="63"  align="center" class="u1">文件链接网址</th>
        <th  height="63"  align="center" class="u1">收费</th>
    ...
    <tr>
        ...
        <td align="center" valign="middle" class="u14"><%# Eval("rate")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("base")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("calculateformula")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("department")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("applydate")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("receivedate")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("filetxt")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("filelink")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("fee")%></td>
...
<script type="text/javascript">
    function GoPages() {
        ...
        window.location.href = "CompanyDisbilitymoneyInfo.aspx?YearTime=" + yearTime + "&provinceType=" + provinceType + "&cityType=" + cityType + "&pagesize=" + pageNum + "&pagenum=5";
    }
    ...
    function searchInfo() {
        ...
        var provinceType = $('#ddlProvince option:selected').val();
        var cityType = $('#ddlCity option:selected').val();
        window.location.href = "CompanyDisbilitymoneyInfo.aspx?YearTime=" + yearTime + "&provinceType=" + provinceType + "&cityType=" + cityType;
    }
</script>
</html>