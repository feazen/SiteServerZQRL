<%@ Page Language="C#" AutoEventWireup="true" Inherits="SiteServer.ZQRL.ForegroundPages.CompanyRemotemedicalInfos" %>
...
<div id="content">
    <div class="CompanyFundrate">
        <select  id="selectCompanyFund" style=" width:160px;" onchange="self.location.href=options[selectedIndex].value">
              ...
              <option selected="selected" value="CompanyRemotemedicalInfo.aspx"> 异地就医</option>
...
<div class="scroll">
  <table width="2000" border="0" cellspacing="0" cellpadding="0" id="tableList" style=" background-image:url(../images/s18.jpg)">
    <tbody><tr>
        ...
        <th  height="63"  align="center" class="u1">材料(异地急诊)</th>
        <th  height="63"  align="center" class="u1">结算方式(异地急诊)</th>
        <th  height="63"  align="center" class="u1">可否办理异地就医（门诊/住院）</th>
        <th  height="63"  align="center" class="u1">单位办理/个人办理</th>
        <th  height="63"  align="center" class="u1">异地就医办理材料</th>
        <th  height="63"  align="center" class="u1">异地就医办理流程</th>
        <th  height="63"  align="center" class="u1">材料（异地就医）</th>
        <th  height="63"  align="center" class="u1">结算方式（异地就医）</th>
        <th  height="63"  align="center" class="u1">报销时间</th>
    ...
    <tr>
        ...
        <td align="center" valign="middle" class="u14"><%# Eval("removejzmaterial")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("jzbalancetype")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("isremote")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("managetype")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("remotematerial")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("remoteflow")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("removejymaterial")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("jybalancetype")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("expensetime")%></td>
...
<script type="text/javascript">
    function GoPages() {
        ...
        window.location.href = "CompanyRemotemedicalInfo.aspx?YearTime=" + yearTime + "&provinceType=" + provinceType + "&cityType=" + cityType + "&pagesize=" + pageNum + "&pagenum=5";
    }
    ...
    function searchInfo() {
        ...
        var provinceType = $('#ddlProvince option:selected').val();
        var cityType = $('#ddlCity option:selected').val();
        window.location.href = "CompanyRemotemedicalInfo.aspx?YearTime=" + yearTime + "&provinceType=" + provinceType + "&cityType=" + cityType;
    }
</script>
</html>