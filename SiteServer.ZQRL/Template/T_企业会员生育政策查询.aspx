<%@ Page Language="C#" AutoEventWireup="true" Inherits="SiteServer.ZQRL.ForegroundPages.CompanyBearpolicyInfos" %>
...
<div id="content">
    <div class="CompanyFundrate">
        <select  id="selectCompanyFund" style=" width:160px;" onchange="self.location.href=options[selectedIndex].value">
              ...
              <option selected="selected" value="CompanyBearpolicyInfo.aspx"> 生育政策</option>
...
<div class="scroll">
  <table width="2000" border="0" cellspacing="0" cellpadding="0" id="tableList" style=" background-image:url(../images/s18.jpg)">
    <tbody><tr>
        ...
        <th  height="63"  align="center" class="u1">享受生育保险待遇的条件</th>
        <th  height="63"  align="center" class="u1">生育保险待遇</th>
        <th  height="63"  align="center" class="u1">生育津贴标准</th>
        <th  height="63"  align="center" class="u1">生育登记备案</th>
        <th  height="63"  align="center" class="u1">生育津贴发放</th>
        <th  height="63"  align="center" class="u1">生育保险补缴</th>
        <th  height="63"  align="center" class="u1">婚假</th>
        <th  height="63"  align="center" class="u1">产前假</th>
        <th  height="63"  align="center" class="u1">产假</th>
        <th  height="63"  align="center" class="u1">流产假</th>
        <th  height="63"  align="center" class="u1">陪产假</th>
        <th  height="63"  align="center" class="u1">审核、领取生育保险待遇时间</th>
        <th  height="63"  align="center" class="u1">生育待遇办理公司/个人</th>
        <th  height="63"  align="center" class="u1">流产生育津贴</th>
        <th  height="63"  align="center" class="u1">享受生育待遇（男方）</th>
        <th  height="63"  align="center" class="u1">其他</th>
    ...
    <tr>
        ...
        <td align="center" valign="middle" class="u14"><%# Eval("enjoyterm")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("enjoytreat")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("enjoystandard")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("registrecord")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("benefitissue")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("backpay")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("marriageleave")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("prematernityleave")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("maternityleave")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("abortionleave")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("paternityleave")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("insuracetime")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("managetype")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("abortion")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("manbenefit")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("other")%></td>
...
<script type="text/javascript">
    function GoPages() {
        ...
        window.location.href = "CompanyBearpolicyInfo.aspx?YearTime=" + yearTime + "&provinceType=" + provinceType + "&cityType=" + cityType + "&pagesize=" + pageNum + "&pagenum=5";
    }
    ...
    function searchInfo() {
        ...
        var provinceType = $('#ddlProvince option:selected').val();
        var cityType = $('#ddlCity option:selected').val();
        window.location.href = "CompanyBearpolicyInfo.aspx?YearTime=" + yearTime + "&provinceType=" + provinceType + "&cityType=" + cityType;
    }
</script>
</html>