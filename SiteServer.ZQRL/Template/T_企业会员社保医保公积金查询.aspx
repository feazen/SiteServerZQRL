<%@ Page Language="C#" AutoEventWireup="true" Inherits="SiteServer.ZQRL.ForegroundPages.CompanyFundsearchInfos" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 
...
<div id="content">
    <div class="CompanyFundrate">
        <select  id="selectCompanyFund" style=" width:160px;" onchange="self.location.href=options[selectedIndex].value">
              ...
              <option selected="selected" value="CompanyFundsearchInfo.aspx"> 社保医保公积金查询</option>
...
<div class="scroll">
  <table width="2000" border="0" cellspacing="0" cellpadding="0" id="tableList" style=" background-image:url(../images/s18.jpg)">
    <tbody><tr>
        ...
        <th  height="63"  align="center" class="u1">养老缴费社保凭证</th>
        <th  height="63"  align="center" class="u1">工伤缴费社保凭证</th>
        <th  height="63"  align="center" class="u1">医疗缴费社保凭证</th>
        <th  height="63"  align="center" class="u1">生育缴费社保凭证</th>
        <th  height="63"  align="center" class="u1">失业缴费社保凭证</th>
        <th  height="63"  align="center" class="u1">离职员工社保凭证</th>
        <th  height="63"  align="center" class="u1">公积金凭证</th>
        <th  height="63"  align="center" class="u1">凭证开具时间</th>
        <th  height="63"  align="center" class="u1">社保查询网址</th>
        <th  height="63"  align="center" class="u1">社保查询网址链接</th>
        <th  height="63"  align="center" class="u1">养老保险个人账户查询方式</th>
        <th  height="63"  align="center" class="u1">医保查询网址</th>
        <th  height="63"  align="center" class="u1">医保查询网址链接</th>
        <th  height="63"  align="center" class="u1">医保个人查询方式</th>
        <th  height="63"  align="center" class="u1">公积金查询网址</th>
        <th  height="63"  align="center" class="u1">公积金查询网址链接</th>
        <th  height="63"  align="center" class="u1">公积金账户查询费方式</th>
    ...
    <tr>
        ...
        <td align="center" valign="middle" class="u14"><%# Eval("yangljfcertify")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("gsjfcertify")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("yiljfcertify")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("syujfcertify")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("syejfcertify")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("leaveemppro")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("gjjcertify")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("certifytime")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("searchtxt")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("searthlink")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("ylbxpersonalsearch")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("ybsearthtxt")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("ybsearchlink")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("ybpersonalsearchway")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("gjjsearchtxt")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("gjjsearchlink")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("gjjaccountsearchway")%></td>
...
<script type="text/javascript">
    function GoPages() {
        ...
        window.location.href = "CompanyFundsearchInfo.aspx?YearTime=" + yearTime + "&provinceType=" + provinceType + "&cityType=" + cityType + "&pagesize=" + pageNum + "&pagenum=5";
    }
    ...
    function searchInfo() {
        ...
        var provinceType = $('#ddlProvince option:selected').val();
        var cityType = $('#ddlCity option:selected').val();
        window.location.href = "CompanyFundsearchInfo.aspx?YearTime=" + yearTime + "&provinceType=" + provinceType + "&cityType=" + cityType;
    }
</script>
</html>