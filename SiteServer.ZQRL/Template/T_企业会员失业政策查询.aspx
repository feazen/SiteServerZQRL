<%@ Page Language="C#" AutoEventWireup="true" Inherits="SiteServer.ZQRL.ForegroundPages.CompanyLosejobpolicyInfos" %>
...
<div id="content">
    <div class="CompanyFundrate">
        <select  id="selectCompanyFund" style=" width:160px;" onchange="self.location.href=options[selectedIndex].value">
              ...
              <option selected="selected" value="CompanyLosejobpolicyInfo.aspx"> 失业政策</option>
...
<div class="scroll">
  <table width="2000" border="0" cellspacing="0" cellpadding="0" id="tableList" style=" background-image:url(../images/s18.jpg)">
    <tbody><tr>
        ...
        <th  height="63"  align="center" class="u1">享受失业保险待遇的条件</th>
        <th  height="63"  align="center" class="u1">社保规定的额离职/解除的理由</th>
        <th  height="63"  align="center" class="u1">失业保险待遇</th>
        <th  height="63"  align="center" class="u1">失业进期限标准</th>
        <th  height="63"  align="center" class="u1">失业登记（个人/企业）</th>
        <th  height="63"  align="center" class="u1">生育保险补缴</th>
        <th  height="63"  align="center" class="u1">失业登记</th>
        <th  height="63"  align="center" class="u1">失业金申领及时限</th>
        <th  height="63"  align="center" class="u1">非本市户籍失业金领取</th>
    ...
    <tr>
        ...
        <td align="center" valign="middle" class="u14"><%# Eval("enjoyecondition")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("leavereason")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("enjoybenefit")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("enjoylimit")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("registtype")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("regist")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("moneyget")%></td>
        <td align="center" valign="middle" class="u14"><%# Eval("unlocalget")%></td>
...
<script type="text/javascript">
    function GoPages() {
        ...
        window.location.href = "CompanyLosejobpolicyInfos.aspx?provinceType=" + provinceType + "&cityType=" + cityType + "&pagesize=" + pageNum + "&pagenum=5";
    }
    ...
    function searchInfo() {
        ...
        var provinceType = $('#ddlProvince option:selected').val();
        var cityType = $('#ddlCity option:selected').val();
        window.location.href = "CompanyLosejobpolicyInfos.aspx?provinceType=" + provinceType + "&cityType=" + cityType;
    }
</script>
</html>