<%@ Page Language="C#" AutoEventWireup="true" Inherits="SiteServer.ZQRL.ForegroundPages.CompanySalaryInfosByTime" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 
...
<div class="table">
  ...
  <tbody><tr>
    <th height="46" class="u1" style="padding-left:30px;"  align="left" colspan="2"><input type="hidden" name="fid" id="fid" value="vvv1" >
    日期</th>
    </tr>
      <asp:Repeater ID="rptContents" runat="server" OnItemDataBound="rptContents_ItemDataBound">
    <ItemTemplate>
        <tr class="u6">
        <td class="ico" align="left" style="padding-left:30px;"  colspan="2"><%#   String.Format("{0:yyyy-MM-dd} ", Eval("date"))%> <input type="hidden" value="<%# Eval("salaryId")%>" /></td>
            </tr>
...
<script type="text/javascript">
    function GoPages() {
        ...
        window.location.href = "CompanySalaryInfosByTime.aspx?StartTime=" + StartTime + "&EndTime=" + EndTime+"&pagesize="+pageNum+"&pagenum=5";
    }
    ...
    function searchInfo() {
        ...
        window.location.href = "CompanySalaryInfosByTime.aspx?StartTime=" + StartTime + "&EndTime=" + EndTime + "&NameOrIdCard=" + NameOrIdCard;
