...
{
    public partial class CompanyRemotemedicalInfos : System.Web.UI.Page
    {
        ...
        private void LoadHtml()
        {
            ...
            PageApp pa = new PageApp(pagesize, pagenum, pageSql, " expensetime Desc ");
        ...
        private string GetSql()
        {
            ...
            sb.Append(" [removejzmaterial],[jzbalancetype]	,[isremote]	,[managetype],[remotematerial],[remoteflow],[removejymaterial] ,[jybalancetype],[expensetime],[remark],[filetxt],[filelink] from t_remotemedical t1  ");
            ...
            if (!string.IsNullOrEmpty(YearTime))
            {
                ...
                sb.AppendFormat(" and expensetime like '%{0}%' ", sTime);
            }
        ...
        {
            Response.Redirect(string.Format("CompanyRemotemedicalInfo.aspx?YearTime={0}&provinceType={1}&cityType={2}", this.lblYearTime.Text, this.ddlProvince.SelectedValue, 0));
        }
        ...
        protected string PageUrl
        {
            get
            {
                ...
                {
                    this._pageUrl = string.Format("CompanyRemotemedicalInfo.aspx?YearTime={0}&provinceType={1}&cityType={2}", this.lblYearTime.Text,this.ddlProvince.SelectedValue, this.ddlCity.SelectedValue);
                }
