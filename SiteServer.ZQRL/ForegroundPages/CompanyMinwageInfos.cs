...
{
    public partial class CompanyMinwageInfos : System.Web.UI.Page
    {
        ...
        private void LoadHtml()
        {
            ...
            PageApp pa = new PageApp(pagesize, pagenum, pageSql, " noticedate Desc ");
        ...
        private string GetSql()
        {
            ...
            sb.Append(" t1.[noticedate],t1.[minwage],t1.[minuntotalhour],t1.[year],t1.[filetxt]	,t1.[filelink]	,t1.[remark] from t_minwage t1 ");
            ...
            if (!string.IsNullOrEmpty(YearTime))
            {
                ...
                sb.AppendFormat(" and noticedate like '%{0}%' ", sTime);
            }
        ...
        {
            Response.Redirect(string.Format("CompanyMinwageInfo.aspx?YearTime={0}&provinceType={1}&cityType={2}", this.lblYearTime.Text, this.ddlProvince.SelectedValue, 0));
        }
        ...
        protected string PageUrl
        {
            get
            {
                ...
                {
                    this._pageUrl = string.Format("CompanyMinwageInfo.aspx?YearTime={0}&provinceType={1}&cityType={2}", this.lblYearTime.Text, this.ddlProvince.SelectedValue, this.ddlCity.SelectedValue);
                }
