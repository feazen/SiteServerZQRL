...
{
    public partial class FLGSkipPage : System.Web.UI.Page
    {
        ...
        string flgDeclarePageDir = "/SiteServer/ZQRL/Template/FLGDeclarePage.aspx";//提示消息框，用于第一次登陆福利高时的显示
       
        bool isRegistFLG = false;      //是否关联福利高账户

        //string loginPwd_md5 = null;   //密码
        protected void Page_Load(object sender, EventArgs e)
        {
            //registURL = "https://www-1.fuiou.com/fwp/fuiouEyAction .action";//测试环境01(待修改)
            //loginURL = "https://www.fuligold.com/hr-channel";//测试环境02(待修改)
            ...
            if (registFLGUser() && loginId != null && firmNo != null)
            {
                ...
                if (isRegistFLG )
                    ...
                    Response.Redirect(flgDeclarePageDir);
            }
            else
            {
                //其他情况链接到成功网页
                //Response.Write("<script languge='javascript'>alert('这还是不能显示？？？？！！！！“”“”“');</script>");
                Response.Redirect(loginURL);
                //showAttentionURL(attentionMSG, loginURL);
            }
        ...
        */
        ...
        /// @url   跳转页面
        /// </summary>
        private void showAttentionURL(String msg, String url) {
            Response.Write("<script languge='javascript'>alert('" + msg + "'); window.location.href='" + url + "'</script>");
        }
    }
