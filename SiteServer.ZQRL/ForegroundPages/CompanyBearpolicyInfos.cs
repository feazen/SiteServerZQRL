...
{
    public partial class CompanyBearpolicyInfos : System.Web.UI.Page
    {
        ...
        private void LoadHtml()
        {
            ...
            PageApp pa = new PageApp(pagesize, pagenum, pageSql, " insuracetime Desc ");
        ...
        private string GetSql()
        {
            ...
            sb.Append(" t1.[filetxt]	,t1.[filelink]	,t1.[enjoyterm],t1.[enjoytreat],t1.[enjoystandard],t1.[registrecord],t1.[benefitissue]	,t1.[backpay],t1.[marriageleave],t1.[prematernityleave]	,t1.[maternityleave],t1.[abortionleave],t1.[paternityleave],t1.[insuracetime]	,t1.[managetype],t1.[abortion],t1.[manbenefit],t1.[other],t1.[remark] from t_bearpolicy t1 ");
            ...
            if (!string.IsNullOrEmpty(YearTime))
            {
                ...
                sb.AppendFormat(" and insuracetime like '%{0}%' ", sTime);
            }
        ...
        {
            Response.Redirect(string.Format("CompanyBearpolicyInfo.aspx?YearTime={0}&provinceType={1}&cityType={2}", this.lblYearTime.Text, this.ddlProvince.SelectedValue, 0));
        }
        ...
        protected string PageUrl
        {
            get
            {
                ...
                {
                    this._pageUrl = string.Format("CompanyBearpolicyInfo.aspx?YearTime={0}&provinceType={1}&cityType={2}", this.lblYearTime.Text, this.ddlProvince.SelectedValue, this.ddlCity.SelectedValue);
                }
