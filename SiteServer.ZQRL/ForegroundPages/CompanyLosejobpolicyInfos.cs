...
{
    public partial class CompanyLosejobpolicyInfos : System.Web.UI.Page
    {
        ...
        private void LoadHtml()
        {
            ...
            PageApp pa = new PageApp(pagesize, pagenum, pageSql, " dte Desc ");
        ...
        private string GetSql()
        {
            ...
            sb.Append("  select t1.area,t4.name as area_Name,t1.province,t1.city,t2.name as province_Name,t3.name as city_Name,getdate() as dte, ");
            sb.Append(" [filetxt],[filelink],[enjoyecondition],[leavereason]	,[enjoybenefit],[enjoylimit],[registtype],[regist],[moneyget],[unlocalget],[other] from t_losejobpolicy t1  ");
        ...
        {
            Response.Redirect(string.Format("CompanyLosejobpolicyInfo.aspx?provinceType={0}&cityType={1}", this.ddlProvince.SelectedValue, 0));
        }
        ...
        protected string PageUrl
        {
            get
            {
                ...
                {
                    this._pageUrl = string.Format("CompanyLosejobpolicyInfo.aspx?provinceType={0}&cityType={1}",this.ddlProvince.SelectedValue, this.ddlCity.SelectedValue);
                }
